...
public class MemoryCacheManager : ICacheManager
{
    ...
    public void RemoveByPattern(string pattern)
    {
        ...
        // Reflection to get EntriesCollection
        ...
        var cacheEntriesCollection = propertyInfo.GetValue(value) as dynamic;
        if (cacheEntriesCollection == null)
        {
            throw new InvalidOperationException("EntriesCollection could not be retrieved.");
        }
